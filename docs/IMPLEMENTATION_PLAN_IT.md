...
10. **Conclusione** — "più espressività non significa automaticamente migliore calibrazione: nel nostro setting il seasonal-naive resta imbattuto sul CRPS e DeepAR è il modello più calibrato tra quelli addestrati; il valore della diffusione è condizionato e ha un costo di sampling misurabile e regolabile — a cui sappiamo dare un prezzo." + lavori futuri (diffusione bayesiana/a ensemble; calibrazione).
