...
La valutazione *è* il rigore del progetto. Misuriamo tre famiglie + imponiamo igiene statistica.
...
### 6.4 Igiene statistica (non saltarla — è originalità a basso costo)
...
### 6.5 Trappole di valutazione da cui guardarsi attivamente
...
Chiedigli sempre di aggiungere un piccolo test o un controllo di fumo `__main__`. Rivedi ogni diff a fronte delle trappole della Parte 6.5.
...
- **Niente scelte a posteriori:** l'orizzonte, il seed e la soglia si fissano *prima*. Scegliere dopo il più favorevole è cherry-picking (Parte 6.5).
