...
## COMPONENTE A (Giovanni Mason) — problema, dataset, perché probabilistico (~2:45)
...
## COMPONENTE B (Lorenzo Di Bernardo) — la scala dei modelli, TimeGrad, le metriche (~3:00)
...
## COMPONENTE C (Lorenzo Karol Gobbo) — risultati, trade-off, interpretazione, limiti (~3:00)
